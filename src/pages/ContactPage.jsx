  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16 text-center space-y-6">
      ...
      <p className="text-gray-600 dark:text-gray-300">
        I'm open to new opportunities and always happy to talk about full
        stack, AI or cloud development. Feel free to reach out.
      </p>
      <div className="flex flex-col items-center gap-3 text-sm font-medium">
        <a
          href="mailto:meltemgulsenytu@gmail.com"
          className="hover:underline text-purple-700 dark:text-purple-400"
        >
          ✉️ meltemgulsenytu@gmail.com
        </a>
        <a
        ...
        <a
          href="https://www.linkedin.com/in/meltem-gulsen/"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:underline text-purple-700 dark:text-purple-400"
        >
          💼 linkedin.com/in/meltem-gulsen
        </a>
      </div>
    </div>
  );
